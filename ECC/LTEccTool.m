...
- (void)genSecKey:(unsigned char *)secKey32 keyPhrase:(NSString *)strphrase{
    ...
    /// Kj3rk8+cKYG8sAhXO5gkU5nRrBzuhhS7ts953vdhVHE=
    const uint8_t salt[] = {0x2a,0x3d,0xeb,0x93,0xcf,0x9c,0x29,0x81,0xbc,0xb0,0x08,0x57,0x3b,0x98,0x24,0x53,0x99,0xd1,0xac,0x1c,0xee,0x86,0x14,0xbb,0xb6,0xcf,0x79,0xde,0xf7,0x61,0x54,0x71} ;
